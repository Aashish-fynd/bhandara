...
import { REACTION_TABLE_NAME, COMMON_EMOJIS, EAllowedReactionTables, } from "./constants";
...
export const validateReactionCreate = validateSchema(`${REACTION_TABLE_NAME}_CREATE`, reactionSchema);
export const validateReactionUpdate = validateSchema(`${REACTION_TABLE_NAME}_UPDATE`, updateSchema);
