...
export const searchQuerySchema = Joi.object({
    ...
    filters: Joi.object({
        ...
        eventStatus: Joi.array().items(Joi.string().valid(...Object.values(EEventStatus))),
        eventType: Joi.array().items(Joi.string().valid(...Object.values(EEventType))),
...
export const validateSuggestionsRequest = (data) => {
