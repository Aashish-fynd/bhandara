...
export const getExplorePage = (userId) => exploreCache.getItem(userId);
export const setExplorePage = (userId, page) => exploreCache.setItem(userId, page);
export const deleteExplorePage = (userId) => exploreCache.deleteItem(userId);
export var EExploreComponents;
(function (EExploreComponents) {
    EExploreComponents["TasteCalendar"] = "taste-calendar";
    EExploreComponents["FoodieFeed"] = "foodie-feed";
    EExploreComponents["Reels"] = "reels";
    EExploreComponents["Collaborations"] = "collaborations";
    EExploreComponents["Trending"] = "trending";
})(EExploreComponents || (EExploreComponents = {}));
...
export const buildExploreSections = (events) => {
    ...
    const trendingPayload = [...events]
        .sort((a, b) => (Array.isArray(b.participants) ? b.participants.length : 0) -
