...
const customFormat = format.printf(({ level, message, timestamp, service, stack, ...temp }) => {
    const logMessage = {
        asctime: timestamp,
...
const logger = createLogger({
    ...
    format: format.combine(format.splat(), format.json(), errors({ stack: true }), format.timestamp({
