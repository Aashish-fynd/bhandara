...
import { asyncHandler, sessionParser, userParser, validateParams, } from "@middlewares";
import { updateEvent, getEventById, createEvent, getEvents, deleteEventTag, eventJoinLeaveHandler, verifyEvent, deleteEventMedia, getEventThreads, deleteEvent, } from "@features/events/controller";
const router = Router();
